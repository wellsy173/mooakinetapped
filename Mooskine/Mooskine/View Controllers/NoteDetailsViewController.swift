...
extension NoteDetailsViewController {
    ...
    func makeToolbarItems() -> [UIBarButtonItem] {
        ...
        let bold = UIBarButtonItem (image: UIImage(imageLiteralResourceName: "image_asset_name"), style: .plain, target: self, action: #selector(boldTapped(sender:)))
        let red = UIBarButtonItem (image: UIImage(imageLiteralResourceName: "image_asset_name"), style: .plain, target: self, action: #selector(redTapped(sender:)))
        let cow = UIBarButtonItem (image: UIImage(imageLiteralResourceName: "image_asset_name"), style: .plain, target: self, action: #selector(cowTapped(sender:)))
        return [trash, space]
    }
